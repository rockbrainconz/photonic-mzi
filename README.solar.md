# Experimental sunlight matrix MAC branch

[English](README.solar.md) | [简体中文](README.solar.zh-CN.md)

> **Status: experimental.** This is the landing page for
> `experiment/solar-incoherent`. The branch studies incoherent sunlight intensity
> computing; it is not a source replacement for the coherent MZI processor.

## Purpose

The target remains a real matrix multiply-accumulate:

```text
y = Mx + b
```

The physical path is different from the main MZI backend:
...
## Difference from the main backend

| Property | `PhotonicMatrixProcessor` | `IncoherentSolarProcessor` |
|---|---|---|
